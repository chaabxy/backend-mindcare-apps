...
const DataPakarController = {
  ...
  async getGejala(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal mengambil data gejala" })
        .code(500);
    }
  },
  ...
  async createGejala(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal membuat gejala" })
        .code(500);
    }
  },
  ...
  async updateGejala(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal mengupdate gejala" })
        .code(500);
    }
  },
  ...
  async deleteGejala(request, h) {
    try {
      ...
      return h
        .response({ success: true, message: "Gejala berhasil dihapus" })
        .code(200);
    } catch (error) {
      return h
        .response({ success: false, message: "Gagal menghapus gejala" })
        .code(500);
    }
  },
  ...
  async getPenyakit(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal mengambil data penyakit" })
        .code(500);
    }
  },
  ...
  async createPenyakit(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal membuat penyakit" })
        .code(500);
    }
  },
  ...
  async updatePenyakit(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal mengupdate penyakit" })
        .code(500);
    }
  },
  ...
  async deletePenyakit(request, h) {
    try {
      ...
      return h
        .response({ success: true, message: "Penyakit berhasil dihapus" })
        .code(200);
    } catch (error) {
      return h
        .response({ success: false, message: "Gagal menghapus penyakit" })
        .code(500);
    }
  },
  ...
  async getRules(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal mengambil data rules" })
        .code(500);
    }
  },
  ...
  async createRule(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal membuat rule" })
        .code(500);
    }
  },
  ...
  async updateRule(request, h) {
    try {
      ...
      return h
        .response({ success: false, message: "Gagal mengupdate rule" })
        .code(500);
    }
  },
  ...
  async deleteRule(request, h) {
    try {
      ...
      return h
        .response({ success: true, message: "Rule berhasil dihapus" })
        .code(200);
    } catch (error) {
      return h
        .response({ success: false, message: "Gagal menghapus rule" })
        .code(500);
    }
  },
  ...
  async exportGejala(request, h) {
    try {
      ...
      return h
        ...
        .header(
          "Content-Disposition",
          `attachment; filename="data-gejala-${
      ...
      return h
        .response({ success: false, message: "Gagal export data gejala" })
        .code(500);
    }
  },
  ...
  async exportRules(request, h) {
    try {
      ...
      return h
        ...
        .header(
          "Content-Disposition",
          `attachment; filename="data-rules-${
            new Date().toISOString().split("T")[0]
          }.xlsx"`
        )
        .code(200);
      ...
      return h
        .response({ success: false, message: "Gagal export data rules" })
        .code(500);
    }
  },
};
